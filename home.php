	...
	<div class="Container">
		<div class="head">
			<ul class="logo">
		        ...
		        <script type="text/javascript">			/*Thay đổi giao diện*/
				...
				<!-- <li><a href="loginUser.php"><span id="char4">Login</span></a></li> -->
				<li><a href="logout.php"><span id="char4">Đăng xuất</span></a></li>
		...
		<div class="menu">
			<div class="mune_left">
          	...
          	<div class="viewright">
		        ...
		        <script>						/*Trượt ảnh hay gọi là SlideShow*/
		        var slideIndex = 1;

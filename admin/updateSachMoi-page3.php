...
<body>
	<?php
		$id = $_GET["key"];
		require("connect.php");
		$sql = "select * from sachmoi_page3 where id = $id";
		...
		if(isset($_POST["btnUpdate"]))
		{
			...
			$sql_page3 = "update sachmoi_page3 set link_page = '$link', photo = '$photo', title = '$title'
									where id = $id";

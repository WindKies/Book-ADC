...
<head>
    ...
    <title>Review: Bí Mật tỉ Đô</title>
...
<body>
    ...
    <div class="menu">
        ...
        <div class="menu-right">
            <h1>Review: Bí Mật tỉ Đô </h1>
            <p>Bí mật tỷ đô là một kiệt tác uyên thâm và sâu sắc. Tác phẩm đã thể hiện hết sự cống hiến, khôn khéo và can đảm được khảm vào tâm hồn của Rafael Badziag và hơn 20 tỷ phú được ông phỏng vấn. Sức mạnh của tác phẩm gối đầu giường cho bất kỳ doanh nhân nào nằm ở bản chất khoa học trong phương pháp của Badziag: các dữ liệu nghiên cứu tỉ mỉ từ những cá nhân hoàn toàn khác biệt, những người có bối cảnh xuất thân khác nhau và con đường tiến thân cũng khác nhau.
            .</p>
            <div class="picture">
            ...
            <p>
          Cuốn sách không phải một tác phẩm được viết từ trí tưởng tượng và ý kiến cá nhân của một nhà văn ngồi trong phòng mà là sản phẩm lao động của một người đàn ông đã đi khắp thế giới, học hỏi từ những người giỏi nhất và chia sẻ điều mình học được với những người có cùng khao khát thành công cháy bỏng trong tâm can.”
            ...
            <h2>
                3. Review sách “Bí mật tỉ đô”
            </h2>
            <p>
           Jannelle So, dẫn chương trình kiêm nhà sản xuất của TFC and Lifestyle Network
           Không chỉ là một doanh nhân toàn cầu, diễn giả TED hàng đầu và tác giả từng đạt nhiều giải thưởng, Rafael Badziag còn là một chuyên gia trong lĩnh vực tâm lý học doanh nhân chuyên về các tỷ phú tự thân, từng xuất hiện trên những tờ báo cũng như kênh truyền hình quốc gia ở nhiều nước khác nhau.

            </p>
            <p>
            Rafael đã làm việc với hơn 20 tỷ phú tự thân khắp thế giới và là người đầu tiên thuyết phục được nhiều tỷ phú tham gia dự án viết sách ở cấp độ toàn cầu, vì vậy ông được gọi là “nam châm hút tỷ phú”.
            </p>

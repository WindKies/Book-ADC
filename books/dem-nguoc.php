...
<body>
    ...
    <div class="menu">
        ...
        <div class="menu-right">
            <h1>Review: Đếm Ngược </h1>
            <div class="picture">
                <img src="https://salt.tikicdn.com/ts/product/ef/18/a6/ddb8c2c41a3365744d2ed10d4a7f5cb1.jpg" width="600" height="657">
            </div>
            <h2>TÓM TẮT NỘI DUNG TRUYỆN</h2>
            <p>Sau khi thân phận được minh bạch trong cuốn thứ nhất của series Đặc vụ Grace Allendale, nữ sĩ quan điều tra vẫn chưa được yên ổn với hạnh phúc mới chớm nở ở Stoke-on-Trent.</p>
            <p>Tích tắc! Tích tắc! Những án mạng liên tiếp khi đội cảnh sát điều tra chưa kịp trở tay. Nạn nhân gần như không có gì liên quan tới nhau, từ nữ sinh đến một người mẹ trẻ đang nuôi con nhỏ. Kỳ quái hơn, đội điều tra dần nhận ra án mạng liên hoàn này có sự lặp lại của một vụ án từ mấy năm trước, về cách thức gây án và những thu nhận hiện trường. Nhưng hung thủ của vụ án cũ đang ngồi tù. Liệu đây chỉ là một kẻ bắt chước có ý đồ mờ ám hay có một kẻ giật dây từ đầu đến cuối?</p>
            <div class="picture">
                <img src="https://salt.tikicdn.com/ts/product/10/0c/0f/21ebd983c403646eb5345380d1a3f9a2.jpg" width="600" height="657">
            </div>
            <p>Đặc vụ Grace và các đồng nghiệp liệu có tìm ra mối kết nối giữa vụ án trước khi nạn nhân thứ năm rơi vào tay kẻ giết người?</p>
            <p>Không chỉ đấu trí, để bắt được hung thủ còn là một pha rượt đuổi căng thẳng đến nghẹt thở.</p>
            <p>Tích tắc! Tích tắc!</p>
            <p>“Một sự tái hiện chân thực, cuốn và gấp gáp khiến bạn không thể bỏ cuốn sách xuống.” – Caroline Mitchell, tác giả của The Secret Child.</p>
            <h2>Kết luận</h2>
            <p>Sách Đếm Ngược là cuốn sách được nhiều người đón nhận, sách mang đến cho người dùng những trải nghiệm thú vị, mang lại những phút thư giãn, ngoài ra Sách mang đến cho bạn thứ còn quan trọng hơn cả kiến thức, đó là trí tưởng tượng. Rất nhiều những cuốn sách đã thay đổi cuộc đời người khác và sẽ có một cuốn sách thay đổi cuộc đời bạn, hãy tìm ra nó. Sách giết mọi khoảng thời gian trống vô nghĩa giúp cuộc sống của bạn ý nghĩa hơn!</p>
